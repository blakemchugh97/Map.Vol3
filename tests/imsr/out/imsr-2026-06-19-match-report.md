# IMSR ↔ incident-layer match — 2026-06-19

- IMSR source: `tests/imsr/out/imsr-2026-06-19-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-06-19.json` (420 records)
...
- Match rate (exact+strong+weak): **93.5%**
- EXACT **27** · STRONG **2** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **2**
- Layer records with no IMSR match: **391** (expected — IMSR lists only large incidents)
