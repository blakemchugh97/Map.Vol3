# IMSR ↔ incident-layer match — 2026-06-24

- IMSR source: `tests/imsr/out/imsr-2026-06-24-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-06-24.json` (418 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **33**
- Match rate (exact+strong+weak): **87.9%**
- EXACT **27** · STRONG **2** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **4**
- Layer records with no IMSR match: **389** (expected — IMSR lists only large incidents)
