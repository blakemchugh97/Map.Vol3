# IMSR ↔ incident-layer match — 2026-06-26

- IMSR source: `tests/imsr/out/imsr-2026-06-26-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-06-26.json` (455 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **40**
- Match rate (exact+strong+weak): **95.0%**
- EXACT **36** · STRONG **2** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **2**
...
| FL-FLS/Ehren Cutoff 51 | **STRONG** | 2026-FLFLS-261100489 | 0.85 | name=0.667,unit=Y,st=Y,yr=Y |
...
| CO-PSF/Wagon Wheel | **EXACT** | 2026-COPSF-001053 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
