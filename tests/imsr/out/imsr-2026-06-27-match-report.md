# IMSR ↔ incident-layer match — 2026-06-27

- IMSR source: `tests/imsr/out/imsr-2026-06-27-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-06-27.json` (455 records)
...
- EXACT **35** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **4**
- Layer records with no IMSR match: **419** (expected — IMSR lists only large incidents)
...
| UT-FIF/Wild Goose | **NO_MATCH** | — | 0.0 | — |
