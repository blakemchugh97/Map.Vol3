# IMSR ↔ incident-layer match — 2026-06-30

- IMSR source: `tests/imsr/out/imsr-2026-06-30-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-06-30.json` (424 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **57**
- Match rate (exact+strong+weak): **94.7%**
- EXACT **53** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **3**
- Layer records with no IMSR match: **370** (expected — IMSR lists only large incidents)
...
| CO-GRD/Red Rock | **EXACT** | 2026-COGRD-260197 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| WY-GOX/Rocky Ridge | **EXACT** | 2026-WYGOX-000214 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| CO-SJF/Doe Canyon | **EXACT** | 2026-COSJF-000532 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| WA-SES/Lyle Hill | **EXACT** | 2026-WASES-260291 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| FL-FLS/Hells Bay 48 | **STRONG** | 2026-FLFLS-261200409 | 0.85 | name=0.667,unit=Y,st=Y,yr=Y |
| CA-RRU/Iron | **EXACT** | 2026-CARRU-103569 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| CA-NOD/Romero | **NO_MATCH** | — | 0.0 | — |
