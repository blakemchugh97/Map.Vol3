# IMSR ↔ incident-layer match — 2026-07-01

- IMSR source: `tests/imsr/out/imsr-2026-07-01-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-01.json` (426 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **51**
- Match rate (exact+strong+weak): **96.1%**
- EXACT **49** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **2**
- Layer records with no IMSR match: **377** (expected — IMSR lists only large incidents)
