# IMSR ↔ incident-layer match — 2026-07-02

- IMSR source: `tests/imsr/out/imsr-2026-07-02-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-02.json` (397 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **53**
- Match rate (exact+strong+weak): **98.1%**
- EXACT **51** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **1**
- Layer records with no IMSR match: **345** (expected — IMSR lists only large incidents)
...
| CO-HUX/Sheep Head | **EXACT** | 2026-COHUX-001163 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| NE-NES/Log Road | **EXACT** | 2026-NENES-260581 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| UT-DRD/Horse Head | **EXACT** | 2026-UTDRD-005117 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| WA-SES/Henderson | **EXACT** | 2026-WASES-260308 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OR-VAD/Butterfield Spring | **EXACT** | 2026-ORVAD-260120 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| WA-MCR/Lambdin | **EXACT** | 2026-WAMCR-260297 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OR-PRD/0366 Cedar | **EXACT** | 2026-ORPRD-000366 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| FL-FLS/Atlantic 06 | **NO_MATCH** | — | 0.0 | — |
| FL-LWR/Rookery | **EXACT** | 2026-FLLWR-001886 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| FL-FLS/Black Bird Ranch 14 | **STRONG** | 2026-FLFLS-261500472 | 0.888 | name=0.75,unit=Y,st=Y,yr=Y |
...
- 2026-WACOA-260106 — Kartar (WA, 11746 ac)
