# IMSR ↔ incident-layer match — 2026-07-03

- IMSR source: `tests/imsr/out/imsr-2026-07-03-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-03.json` (404 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **44**
- Match rate (exact+strong+weak): **95.5%**
- EXACT **42** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **2**
...
| OR-VAD/Butterfield Spring | **NO_MATCH** | — | 0.0 | — |
