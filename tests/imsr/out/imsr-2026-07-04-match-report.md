# IMSR ↔ incident-layer match — 2026-07-04

- IMSR source: `tests/imsr/out/imsr-2026-07-04-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-04.json` (414 records)
...
- EXACT **41** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **0**
- Layer records with no IMSR match: **373** (expected — IMSR lists only large incidents)
