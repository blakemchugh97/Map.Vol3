# IMSR ↔ incident-layer match — 2026-07-05

- IMSR source: `tests/imsr/out/imsr-2026-07-05-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-05.json` (617 records)
...
- EXACT **40** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **1**
- Layer records with no IMSR match: **576** (expected — IMSR lists only large incidents)
...
| WY-WYS/Night Draw | **NO_MATCH** | — | 0.0 | — |
...
| WA-SES/Crawford Oaks | **EXACT** | 2026-WASES-260318 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| MT-LG10/Lost Cabin | **EXACT** | 2026-MTLG10-260577 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
