# IMSR ↔ incident-layer match — 2026-07-06

- IMSR source: `tests/imsr/out/imsr-2026-07-06-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-06.json` (680 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **36**
- Match rate (exact+strong+weak): **100.0%**
- EXACT **35** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **0**
- Layer records with no IMSR match: **644** (expected — IMSR lists only large incidents)
...
- 2026-NVHUMX-020340 — Dutch Flat (NV, 15124 ac)
