# IMSR ↔ incident-layer match — 2026-07-07

- IMSR source: `tests/imsr/out/imsr-2026-07-07-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-07.json` (717 records)
...
- EXACT **36** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **0**
- Layer records with no IMSR match: **680** (expected — IMSR lists only large incidents)
...
| WY-CRX/Wind Creek | **EXACT** | 2026-WYCRX-260625 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| ID-BOD/Pvr | **EXACT** | 2026-IDBOD-000617 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| ID-BOD/Mora | **EXACT** | 2026-IDBOD-000614 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
