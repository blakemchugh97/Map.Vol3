# IMSR ↔ incident-layer match — 2026-07-10

- IMSR source: `tests/imsr/out/imsr-2026-07-10-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-10.json` (478 records)
...
- EXACT **41** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **1**
...
| OR-VAD/Whiskey | **EXACT** | 2026-ORVAD-260145 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-ID1AX-000618 — RA 6 ADA CO CLAREMONT (ID, 6564.5 ac)
