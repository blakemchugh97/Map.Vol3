# IMSR ↔ incident-layer match — 2026-07-13

- IMSR source: `tests/imsr/out/imsr-2026-07-13-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-13.json` (481 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **46**
- Match rate (exact+strong+weak): **95.7%**
- EXACT **42** · STRONG **2** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **2**
- Layer records with no IMSR match: **437** (expected — IMSR lists only large incidents)
...
| ID-IFD/Cow Canyon | **EXACT** | 2026-IDIFD-000128 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-WASES-260321 — CHELAN HILLS (WA, 9861 ac)
