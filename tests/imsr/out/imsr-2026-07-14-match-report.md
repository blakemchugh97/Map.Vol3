# IMSR ↔ incident-layer match — 2026-07-14

- IMSR source: `tests/imsr/out/imsr-2026-07-14-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-14.json` (487 records)
...
- EXACT **44** · STRONG **2** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **2**
- Layer records with no IMSR match: **441** (expected — IMSR lists only large incidents)
...
| WY-CMX/Wildhorse Creek | **EXACT** | 2026-WYCMX-000278 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
