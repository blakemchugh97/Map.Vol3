# IMSR ↔ incident-layer match — 2026-07-16

- IMSR source: `tests/imsr/out/imsr-2026-07-16-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-16.json` (582 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **52**
- Match rate (exact+strong+weak): **94.2%**
- EXACT **45** · STRONG **3** · WEAK **1** · AMBIGUOUS **0** · NO_MATCH **3**
- Layer records with no IMSR match: **533** (expected — IMSR lists only large incidents)
...
| OR-973S/Mutual Aid | **WEAK** | 2026-ORUMA-000255 | 0.6 | name=0.667,unit=n,st=Y,yr=Y |
| WA-NES/B And O | **EXACT** | 2026-WANES-001607 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| WA-SPD/Stine | **EXACT** | 2026-WASPD-260397 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| FL-FLS/Bucket Shop 53 | **STRONG** | 2026-FLFLS-261400379 | 0.85 | name=0.667,unit=Y,st=Y,yr=Y |
