# IMSR ↔ incident-layer match — 2026-07-18

- IMSR source: `tests/imsr/out/imsr-2026-07-18-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-18.json` (615 records)
...
- Match rate (exact+strong+weak): **80.0%**
- EXACT **51** · STRONG **9** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **15**
- Layer records with no IMSR match: **555** (expected — IMSR lists only large incidents)

## Top failure / ambiguity reasons
- 13× — no name/unit signal in layer
...
| OR-973S/Bradley Flats | **EXACT** | 2026-OR973S-000343 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| OR-956S/Bologna | **STRONG** | 2026-ORUMF-000298 | 0.75 | name=EX,unit=n,st=Y,yr=Y |
...
| ID-TFD/Sailor | **EXACT** | 2026-IDTFD-000136 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| UT-UWF/Buck Basin | **EXACT** | 2026-UTUWF-200428 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| ID-TFD/Black Ridge 2 | **EXACT** | 2026-IDTFD-000133 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-OROCF-000500 — 0500 COYOTE (OR, 15000 ac)
