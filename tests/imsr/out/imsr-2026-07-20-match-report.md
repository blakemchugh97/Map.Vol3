# IMSR ↔ incident-layer match — 2026-07-20

- IMSR source: `tests/imsr/out/imsr-2026-07-20-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-20.json` (497 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **68**
- Match rate (exact+strong+weak): **83.8%**
- EXACT **53** · STRONG **4** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **11**
...
| ID-TFD/Grassy Hills | **NO_MATCH** | — | 0.0 | — |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 113046 ac)
...
- 2026-ORPRD-000497 — 0497 HENRY (OR, 25000 ac)
