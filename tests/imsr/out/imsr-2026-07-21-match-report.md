# IMSR ↔ incident-layer match — 2026-07-21

- IMSR source: `tests/imsr/out/imsr-2026-07-21-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-21.json` (460 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **65**
- Match rate (exact+strong+weak): **83.1%**
- EXACT **51** · STRONG **3** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **11**
- Layer records with no IMSR match: **406** (expected — IMSR lists only large incidents)
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 119530 ac)
...
- 2026-ORPRD-000449 — 0449 PORCUPINE RIDGE (OR, 23337 ac)
- 2026-ORPRD-000462 — 0462 (OR, 22815 ac)
