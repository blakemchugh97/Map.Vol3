# IMSR ↔ incident-layer match — 2026-07-23

- IMSR source: `tests/imsr/out/imsr-2026-07-23-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-23.json` (519 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **70**
- Match rate (exact+strong+weak): **81.4%**
- EXACT **54** · STRONG **3** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **13**
- Layer records with no IMSR match: **462** (expected — IMSR lists only large incidents)
...
| OR-PRD/0493 Connant | **EXACT** | 2026-ORPRD-000493 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| NV-EURX/Little Cottonwood | **NO_MATCH** | — | 0.0 | — |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 122440 ac)
- 2026-ORPRD-000449 — 0449 PORCUPINE RIDGE (OR, 76859 ac)
- 2026-ORPRD-000476 — 0476 HOAG (OR, 50224 ac)
- 2026-UTSCS-260194 — Iron (UT, 41842 ac)
- 2026-WAWFS-260428 — LYONS FERRY (WA, 33749 ac)
- 2026-OR951S-000433 — 0433 BREWER (OR, 29878 ac)
