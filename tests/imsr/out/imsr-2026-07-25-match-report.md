# IMSR ↔ incident-layer match — 2026-07-25

- IMSR source: `tests/imsr/out/imsr-2026-07-25-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-25.json` (659 records)
...
- Match rate (exact+strong+weak): **86.4%**
- EXACT **74** · STRONG **2** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **12**
- Layer records with no IMSR match: **583** (expected — IMSR lists only large incidents)
