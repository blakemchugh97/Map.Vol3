# IMSR ↔ incident-layer match — 2026-07-29

- IMSR source: `tests/imsr/out/imsr-2026-07-29-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-29.json` (645 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **89**
- Match rate (exact+strong+weak): **92.1%**
- EXACT **79** · STRONG **3** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **7**
- Layer records with no IMSR match: **563** (expected — IMSR lists only large incidents)

## Top failure / ambiguity reasons
- 7× — no name/unit signal in layer
...
| MT-HLF/Twin Sisters | **EXACT** | 2026-MTHLF-000497 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| MT-LG09/Moore Road | **NO_MATCH** | — | 0.0 | — |
...
| UT-BRS/Promontory | **EXACT** | 2026-UTBRS-200527 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| UT-BRS/Adams | **EXACT** | 2026-UTBRS-200523 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| FL-SET/L 28 | **EXACT** | 2026-FLSET-002349 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| GA-WSR/Loggerhead | **EXACT** | 2026-GAWSR-000354 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 174969 ac)
...
- 2026-ORPRD-000567 — 0567 LITTLE BUCK (OR, 36025 ac)
