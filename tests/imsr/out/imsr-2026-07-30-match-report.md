# IMSR ↔ incident-layer match — 2026-07-30

- IMSR source: `tests/imsr/out/imsr-2026-07-30-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-07-30.json` (645 records)
...
- Match rate (exact+strong+weak): **93.2%**
- EXACT **79** · STRONG **3** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **6**
...
| OR-PRD/0615 | **EXACT** | 2026-ORPRD-000615 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| ID-8BN/Bonneville County Assist 4 | **EXACT** | 2026-ID8BN-000142 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 180429 ac)
