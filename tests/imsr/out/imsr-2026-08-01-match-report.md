# IMSR ↔ incident-layer match — 2026-08-01

- IMSR source: `tests/imsr/out/imsr-2026-08-01-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-01.json` (581 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **83**
- Match rate (exact+strong+weak): **91.6%**
- EXACT **72** · STRONG **4** · WEAK **0** · AMBIGUOUS **1** · NO_MATCH **6**
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 189794 ac)
