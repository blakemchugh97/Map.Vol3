# IMSR ↔ incident-layer match — 2026-08-02

- IMSR source: `tests/imsr/out/imsr-2026-08-02-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-02.json` (578 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **99**
- Match rate (exact+strong+weak): **91.9%**
- EXACT **88** · STRONG **3** · WEAK **0** · AMBIGUOUS **1** · NO_MATCH **7**
- Layer records with no IMSR match: **487** (expected — IMSR lists only large incidents)
...
| MT-LG22/HWY 91 Inc 964 | **EXACT** | 2026-MTLG22-260964 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| UT-BRS/Johnson Canyon | **EXACT** | 2026-UTBRS-200554 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| WY-SHX/Lumin | **EXACT** | 2026-WYSHX-000363 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| FL-FLS/Hudson 19 Dixie 15 | **STRONG** | 2026-FLFLS-260500267 | 0.888 | name=0.75,unit=Y,st=Y,yr=Y |
| OK-OKS/Semi 270 | **EXACT** | 2026-OKOKS-260786 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 285827 ac)
