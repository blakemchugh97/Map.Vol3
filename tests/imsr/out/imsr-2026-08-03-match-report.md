# IMSR ↔ incident-layer match — 2026-08-03

- IMSR source: `tests/imsr/out/imsr-2026-08-03-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-03.json` (556 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **102**
- Match rate (exact+strong+weak): **93.1%**
- EXACT **91** · STRONG **4** · WEAK **0** · AMBIGUOUS **1** · NO_MATCH **6**
- Layer records with no IMSR match: **461** (expected — IMSR lists only large incidents)
...
| MT-LG19/Middle Coulee | **EXACT** | 2026-MTLG19-000260 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| WY-CRX/Left Creek | **EXACT** | 2026-WYCRX-260784 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 303230 ac)
...
- 2026-NVNAFQ-500729 — MOUSE MEADOW (NV, 37553 ac)
