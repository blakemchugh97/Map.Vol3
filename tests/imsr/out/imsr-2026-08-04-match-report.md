# IMSR ↔ incident-layer match — 2026-08-04

- IMSR source: `tests/imsr/out/imsr-2026-08-04-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-04.json` (561 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **101**
- Match rate (exact+strong+weak): **94.1%**
- EXACT **92** · STRONG **3** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **6**
- Layer records with no IMSR match: **466** (expected — IMSR lists only large incidents)
...
| WA-SPD/South Connell | **EXACT** | 2026-WASPD-260586 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 306347 ac)
