# IMSR ↔ incident-layer match — 2026-08-08

- IMSR source: `tests/imsr/out/imsr-2026-08-08-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-08.json` (552 records)
...
- Match rate (exact+strong+weak): **95.9%**
- EXACT **93** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **4**
- Layer records with no IMSR match: **458** (expected — IMSR lists only large incidents)
...
| WA-YAA/Mccullough Rd | **NO_MATCH** | — | 0.0 | — |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 329027 ac)
