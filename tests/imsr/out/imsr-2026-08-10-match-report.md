# IMSR ↔ incident-layer match — 2026-08-10

- IMSR source: `tests/imsr/out/imsr-2026-08-10-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-10.json` (548 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **100**
- Match rate (exact+strong+weak): **95.0%**
- EXACT **94** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
- Layer records with no IMSR match: **453** (expected — IMSR lists only large incidents)
...
| TX-TXS/Canadian River | **EXACT** | 2026-TXTXS-266729 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OK-OSA/B B | **EXACT** | 2026-OKOSA-002275 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| FL-FLS/06 | **NO_MATCH** | — | 0.0 | — |
| LA-SBR/South Line | **EXACT** | 2026-LASBR-000257 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-NVNAFQ-500729 — MOUSE MEADOW (NV, 51015 ac)
