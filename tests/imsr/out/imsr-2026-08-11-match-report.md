# IMSR ↔ incident-layer match — 2026-08-11

- IMSR source: `tests/imsr/out/imsr-2026-08-11-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-11.json` (569 records)
...
- EXACT **99** · STRONG **0** · WEAK **0** · AMBIGUOUS **1** · NO_MATCH **4**
...
| MT-MCD/Harris | **EXACT** | 2026-MTMCD-000676 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| AR-OUF/Hog Pen | **EXACT** | 2026-AROUF-002344 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 342681 ac)
...
- 2026-NVCCD-030683 — Bug (CA, 44304 ac)
