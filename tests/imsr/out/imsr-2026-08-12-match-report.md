# IMSR ↔ incident-layer match — 2026-08-12

- IMSR source: `tests/imsr/out/imsr-2026-08-12-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-12.json` (594 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **104**
- Match rate (exact+strong+weak): **93.3%**
- EXACT **97** · STRONG **0** · WEAK **0** · AMBIGUOUS **1** · NO_MATCH **6**
- Layer records with no IMSR match: **497** (expected — IMSR lists only large incidents)
...
| WA-WFS/Wells Road | **EXACT** | 2026-WAWFS-001933 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| WA-SES/Alpowa Mutual Aid | **NO_MATCH** | — | 0.0 | — |
...
| WA-WFS/Palouse River | **EXACT** | 2026-WAWFS-001934 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| MT-NCD/White Rock | **EXACT** | 2026-MTNCD-000283 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| WY-COX/Cold Springs | **EXACT** | 2026-WYCOX-000403 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| SD-SDS/Bear Butte | **EXACT** | 2026-SDSDS-260817 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| CA-TUU/Hatchet | **EXACT** | 2026-CATUU-001016 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| CA-SLU/Antelope | **EXACT** | 2026-CASLU-012547 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| TX-TXS/Bufford Creek | **EXACT** | 2026-TXTXS-266794 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OK-OKS/Mill Creek | **EXACT** | 2026-OKOKS-260823 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| FL-FLS/06 | **NO_MATCH** | — | 0.0 | — |
| TX-TXS/Brown | **EXACT** | 2026-TXTXS-266753 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| TX-TXS/Saxon | **EXACT** | 2026-TXTXS-266760 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 344301 ac)
...
- 2026-NVCCD-030683 — Bug (CA, 57363 ac)
