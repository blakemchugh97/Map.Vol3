# IMSR ↔ incident-layer match — 2026-08-13

- IMSR source: `tests/imsr/out/imsr-2026-08-13-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-13.json` (583 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **97**
- Match rate (exact+strong+weak): **93.8%**
- EXACT **91** · STRONG **0** · WEAK **0** · AMBIGUOUS **1** · NO_MATCH **5**
- Layer records with no IMSR match: **492** (expected — IMSR lists only large incidents)
...
| CA-SLU/Plains | **EXACT** | 2026-CASLU-012768 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| CA-TUU/Hatchet | **NO_MATCH** | — | 0.0 | — |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 344672 ac)
...
- 2026-NVCCD-030683 — Bug (CA, 70757 ac)
