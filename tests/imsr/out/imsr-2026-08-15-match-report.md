# IMSR ↔ incident-layer match — 2026-08-15

- IMSR source: `tests/imsr/out/imsr-2026-08-15-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-15.json` (589 records)
...
- Match rate (exact+strong+weak): **94.3%**
- EXACT **82** · STRONG **0** · WEAK **0** · AMBIGUOUS **1** · NO_MATCH **4**
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 344915 ac)
- 2026-UTMLF-005112 — Babylon (UT, 107189 ac)
- 2026-UTFIF-260198 — Cottonwood (UT, 97464 ac)
- 2026-NVCCD-030683 — Bug (CA, 93367 ac)
...
- 2026-ORVAD-260207 — HAT (OR, 42122 ac)
