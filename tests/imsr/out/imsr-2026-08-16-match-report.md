# IMSR ↔ incident-layer match — 2026-08-16

- IMSR source: `tests/imsr/out/imsr-2026-08-16-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-16.json` (569 records)
...
- Match rate (exact+strong+weak): **94.4%**
- EXACT **84** · STRONG **0** · WEAK **0** · AMBIGUOUS **1** · NO_MATCH **4**
- Layer records with no IMSR match: **485** (expected — IMSR lists only large incidents)
...
| ID-BOD/Bigfoot | **EXACT** | 2026-IDBOD-000941 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| CA-TNF/Talbot | **EXACT** | 2026-CATNF-001482 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OK-OKS/Burnt Canyon | **EXACT** | 2026-OKOKS-260858 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OK-ANA/Wichita Hills | **EXACT** | 2026-OKANA-002443 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| FL-FLS/The H1 | **EXACT** | 2026-FLFLS-1800136 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| TX-TXS/Woodson Creek | **EXACT** | 2026-TXTXS-266970 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| TX-TXS/Cedar Hill | **EXACT** | 2026-TXTXS-266999 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
- 2026-NVCCD-030683 — Bug (CA, 94105 ac)
