# IMSR ↔ incident-layer match — 2026-08-18

- IMSR source: `tests/imsr/out/imsr-2026-08-18-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-18.json` (547 records)
...
- EXACT **69** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
- Layer records with no IMSR match: **477** (expected — IMSR lists only large incidents)
...
| FL-FLS/The Radio Tower | **EXACT** | 2026-FLFLS-1800132 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
