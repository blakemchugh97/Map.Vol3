# IMSR ↔ incident-layer match — 2026-08-19

- IMSR source: `tests/imsr/out/imsr-2026-08-19-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-19.json` (558 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **79**
- Match rate (exact+strong+weak): **89.9%**
- EXACT **70** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **8**
...
| WA-NES/Reevas Basin | **EXACT** | 2026-WANES-002007 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| MT-LG14/Bartholomew Reservoir | **NO_MATCH** | — | 0.0 | — |
| MT-LG14/Brown Reservoir | **NO_MATCH** | — | 0.0 | — |
| MT-LG14/Moffitt Dam | **NO_MATCH** | — | 0.0 | — |
| MT-LG14/Emery | **NO_MATCH** | — | 0.0 | — |
...
- 2026-ORPRD-000445 — 0445 CROSSWHITE (OR, 344917 ac)
