# IMSR ↔ incident-layer match — 2026-08-20

- IMSR source: `tests/imsr/out/imsr-2026-08-20-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-20.json` (572 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **72**
- Match rate (exact+strong+weak): **94.4%**
- EXACT **67** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **4**
