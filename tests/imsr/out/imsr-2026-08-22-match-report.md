# IMSR ↔ incident-layer match — 2026-08-22

- IMSR source: `tests/imsr/out/imsr-2026-08-22-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-22.json` (587 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **82**
- Match rate (exact+strong+weak): **93.9%**
- EXACT **76** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
- Layer records with no IMSR match: **510** (expected — IMSR lists only large incidents)
...
| MT-LG19/Mt HWY 80 | **NO_MATCH** | — | 0.0 | — |
...
| UT-BRS/Salt Wells | **EXACT** | 2026-UTBRS-200631 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| AR-ARS/Pine Tree Rd | **EXACT** | 2026-ARARS-400183 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| TX-TXS/Hackberry Creek | **EXACT** | 2026-TXTXS-267323 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| MS-MSS/Franklin Bunkley Rd | **EXACT** | 2026-MSMSS-018390 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| NM-SNF/Frijoles | **EXACT** | 2026-NMSNF-000444 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| NM-N5S/Cooper | **EXACT** | 2026-NMN5S-000659 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
