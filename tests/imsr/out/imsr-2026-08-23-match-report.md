# IMSR ↔ incident-layer match — 2026-08-23

- IMSR source: `tests/imsr/out/imsr-2026-08-23-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-23.json` (618 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **78**
- Match rate (exact+strong+weak): **96.2%**
- EXACT **75** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **3**
- Layer records with no IMSR match: **543** (expected — IMSR lists only large incidents)
...
| ID-BOD/Fraser | **EXACT** | 2026-IDBOD-000973 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
