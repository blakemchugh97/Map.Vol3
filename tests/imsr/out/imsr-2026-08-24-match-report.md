# IMSR ↔ incident-layer match — 2026-08-24

- IMSR source: `tests/imsr/out/imsr-2026-08-24-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-24.json` (652 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **85**
- Match rate (exact+strong+weak): **94.1%**
- EXACT **80** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
- Layer records with no IMSR match: **572** (expected — IMSR lists only large incidents)
...
| OR-WWF/McCulley | **EXACT** | 2026-ORWWF-000531 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| UT-WDD/Big Mountain | **EXACT** | 2026-UTWDD-200650 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
