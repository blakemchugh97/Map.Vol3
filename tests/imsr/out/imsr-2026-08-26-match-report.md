# IMSR ↔ incident-layer match — 2026-08-26

- IMSR source: `tests/imsr/out/imsr-2026-08-26-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-26.json` (689 records)
...
- EXACT **90** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
...
| ID-TFD/Tuana Gulch | **NO_MATCH** | — | 0.0 | — |
