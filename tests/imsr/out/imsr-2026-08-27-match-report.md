# IMSR ↔ incident-layer match — 2026-08-27

- IMSR source: `tests/imsr/out/imsr-2026-08-27-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-27.json` (674 records)
...
- Match rate (exact+strong+weak): **94.6%**
- EXACT **88** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
- Layer records with no IMSR match: **586** (expected — IMSR lists only large incidents)
...
| OR-VAD/Mustang | **EXACT** | 2026-ORVAD-260267 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| NV-HTF/California Creek | **EXACT** | 2026-NVHTF-010537 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| NV-WID/Sombrero | **EXACT** | 2026-NVWID-020597 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| NV-WID/Juniper Ridge | **EXACT** | 2026-NVWID-020599 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| NV-WID/McConnell | **EXACT** | 2026-NVWID-020620 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| ID-BOD/Cave | **EXACT** | 2026-IDBOD-001016 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| NV-ECFX/Bull Run | **EXACT** | 2026-NVECFX-010542 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| FL-FLS/Slough | **EXACT** | 2026-FLFLS-261600697 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
