# IMSR ↔ incident-layer match — 2026-08-29

- IMSR source: `tests/imsr/out/imsr-2026-08-29-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-29.json` (619 records)
...
- Match rate (exact+strong+weak): **91.6%**
- EXACT **87** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **8**
- Layer records with no IMSR match: **532** (expected — IMSR lists only large incidents)
