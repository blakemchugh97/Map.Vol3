# IMSR ↔ incident-layer match — 2026-08-30

- IMSR source: `tests/imsr/out/imsr-2026-08-30-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-30.json` (581 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **98**
- Match rate (exact+strong+weak): **93.9%**
- EXACT **92** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **6**
- Layer records with no IMSR match: **489** (expected — IMSR lists only large incidents)
...
| ID-CAX/Coldwater | **EXACT** | 2026-IDCAX-000227 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| TX-TXS/West Fork | **EXACT** | 2026-TXTXS-267801 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OK-OKS/Wildhorse Creek | **EXACT** | 2026-OKOKS-260957 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| TX-TXS/McKee Draw | **EXACT** | 2026-TXTXS-267823 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OK-OKS/High Fence | **EXACT** | 2026-OKOKS-260964 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OK-OKS/South Beaver Mt | **EXACT** | 2026-OKOKS-260955 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| OK-OKS/Brushy Creek | **EXACT** | 2026-OKOKS-260952 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| TX-TXS/Whitetail | **EXACT** | 2026-TXTXS-267811 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
