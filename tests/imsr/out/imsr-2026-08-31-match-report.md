# IMSR ↔ incident-layer match — 2026-08-31

- IMSR source: `tests/imsr/out/imsr-2026-08-31-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-08-31.json` (597 records)
...
- EXACT **87** · STRONG **2** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **6**
- Layer records with no IMSR match: **508** (expected — IMSR lists only large incidents)
...
| OK-OKS/Alexander Trail | **STRONG** | 2026-OKOKSC-260966 | 0.75 | name=EX,unit=n,st=Y,yr=Y |
