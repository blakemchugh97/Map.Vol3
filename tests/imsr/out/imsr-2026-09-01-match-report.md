# IMSR ↔ incident-layer match — 2026-09-01

- IMSR source: `tests/imsr/out/imsr-2026-09-01-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-01.json` (618 records)
...
- EXACT **84** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **8**
...
| NV-TMFX/Hawk | **EXACT** | 2026-NVTMFX-030739 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| MT-LG33/Horse Camp | **NO_MATCH** | — | 0.0 | — |
...
| TX-TXS/Shotgun | **EXACT** | 2026-TXTXS-267889 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
