# IMSR ↔ incident-layer match — 2026-09-03

- IMSR source: `tests/imsr/out/imsr-2026-09-03-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-03.json` (610 records)
...
- Match rate (exact+strong+weak): **91.1%**
- EXACT **71** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **7**
- Layer records with no IMSR match: **538** (expected — IMSR lists only large incidents)
