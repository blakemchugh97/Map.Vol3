# IMSR ↔ incident-layer match — 2026-09-04

- IMSR source: `tests/imsr/out/imsr-2026-09-04-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-04.json` (538 records)
...
- Match rate (exact+strong+weak): **92.2%**
- EXACT **70** · STRONG **1** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **6**
- Layer records with no IMSR match: **467** (expected — IMSR lists only large incidents)
...
| MT-LG14/Snow | **EXACT** | 2026-MTLG14-000775 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| MT-MCD/Ayers Pond | **EXACT** | 2026-MTMCD-000777 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| MT-MCD/Pine Creek | **EXACT** | 2026-MTMCD-000778 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| TX-TXS/Live Oak | **EXACT** | 2026-TXTXS-268025 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
