# IMSR ↔ incident-layer match — 2026-09-05

- IMSR source: `tests/imsr/out/imsr-2026-09-05-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-05.json` (505 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **77**
- Match rate (exact+strong+weak): **90.9%**
- EXACT **70** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **7**
...
| FL-FLS/S7 | **EXACT** | 2026-FLFLS-1800147 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| WY-WAX/Cow Camp | **EXACT** | 2026-WYWAX-000346 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
