# IMSR ↔ incident-layer match — 2026-09-06

- IMSR source: `tests/imsr/out/imsr-2026-09-06-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-06.json` (473 records)
...
- Match rate (exact+strong+weak): **90.8%**
- EXACT **69** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **7**
- Layer records with no IMSR match: **404** (expected — IMSR lists only large incidents)
...
| MT-LG14/Breaks | **EXACT** | 2026-MTLG14-000791 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| MT-EAS/Rattlesnake Complex | **NO_MATCH** | — | 0.0 | — |
...
| MT-LG09/Three Bar Corral | **EXACT** | 2026-MTLG09-000789 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| MT-LG27/Yodeling Valley | **EXACT** | 2026-MTLG27-000788 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| TX-TXS/Alma | **EXACT** | 2026-TXTXS-268093 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| SD-PRA/Needles | **EXACT** | 2026-SDPRA-000151 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
