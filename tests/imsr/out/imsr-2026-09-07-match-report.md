# IMSR ↔ incident-layer match — 2026-09-07

- IMSR source: `tests/imsr/out/imsr-2026-09-07-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-07.json` (454 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **67**
- Match rate (exact+strong+weak): **88.1%**
- EXACT **59** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **8**
- Layer records with no IMSR match: **395** (expected — IMSR lists only large incidents)
