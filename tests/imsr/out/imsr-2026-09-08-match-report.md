# IMSR ↔ incident-layer match — 2026-09-08

- IMSR source: `tests/imsr/out/imsr-2026-09-08-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-08.json` (494 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **66**
- Match rate (exact+strong+weak): **89.4%**
- EXACT **59** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **7**
...
| TX-TXS/Follow | **EXACT** | 2026-TXTXS-268142 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| TX-TXS/Red Gate | **EXACT** | 2026-TXTXS-268180 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| FL-FLS/Streamsong | **EXACT** | 2026-FLFLS-261400507 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| OK-ANA/Lost Creek | **EXACT** | 2026-OKANA-002722 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
