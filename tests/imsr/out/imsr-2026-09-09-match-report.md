# IMSR ↔ incident-layer match — 2026-09-09

- IMSR source: `tests/imsr/out/imsr-2026-09-09-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-09.json` (525 records)
...
- Match rate (exact+strong+weak): **90.5%**
- EXACT **57** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **6**
- Layer records with no IMSR match: **468** (expected — IMSR lists only large incidents)
