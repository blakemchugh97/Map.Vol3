# IMSR ↔ incident-layer match — 2026-09-10

- IMSR source: `tests/imsr/out/imsr-2026-09-10-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-10.json` (577 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **61**
- Match rate (exact+strong+weak): **91.8%**
- EXACT **56** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
- Layer records with no IMSR match: **521** (expected — IMSR lists only large incidents)
...
| TX-MCR/Unit 12 Middle | **EXACT** | 2026-TXMCR-000375 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| SD-JOX/Van Meter | **EXACT** | 2026-SDJOX-260971 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| SD-STX/Four Corner | **EXACT** | 2026-SDSTX-260972 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
