# IMSR ↔ incident-layer match — 2026-09-11

- IMSR source: `tests/imsr/out/imsr-2026-09-11-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-11.json` (555 records)
...
- EXACT **53** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
- Layer records with no IMSR match: **502** (expected — IMSR lists only large incidents)
...
| MT-LG09/Beaver Creek | **EXACT** | 2026-MTLG09-000803 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
