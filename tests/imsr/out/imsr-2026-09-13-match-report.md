# IMSR ↔ incident-layer match — 2026-09-13

- IMSR source: `tests/imsr/out/imsr-2026-09-13-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-13.json` (512 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **59**
- Match rate (exact+strong+weak): **89.8%**
- EXACT **53** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **6**
