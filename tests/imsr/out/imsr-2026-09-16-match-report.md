# IMSR ↔ incident-layer match — 2026-09-16

- IMSR source: `tests/imsr/out/imsr-2026-09-16-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-16.json` (529 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **64**
- Match rate (exact+strong+weak): **92.2%**
- EXACT **59** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
...
| FL-FLS/Blue Lake | **EXACT** | 2026-FLFLS-1600755 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
| TX-TXS/Upton 3 | **EXACT** | 2026-TXTXS-268533 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| TX-TXS/Elm Creek | **EXACT** | 2026-TXTXS-268549 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
