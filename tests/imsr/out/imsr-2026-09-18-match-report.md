# IMSR ↔ incident-layer match — 2026-09-18

- IMSR source: `tests/imsr/out/imsr-2026-09-18-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-18.json` (521 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **56**
- Match rate (exact+strong+weak): **91.1%**
- EXACT **51** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **5**
...
| AR-OUF/Shell Rock | **NO_MATCH** | — | 0.0 | — |
