# IMSR ↔ incident-layer match — 2026-09-20

- IMSR source: `tests/imsr/out/imsr-2026-09-20-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-20.json` (444 records)
...
- Layer records with no IMSR match: **411** (expected — IMSR lists only large incidents)
