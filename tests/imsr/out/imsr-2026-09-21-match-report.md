# IMSR ↔ incident-layer match — 2026-09-21

- IMSR source: `tests/imsr/out/imsr-2026-09-21-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-21.json` (419 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **34**
- Match rate (exact+strong+weak): **97.1%**
- EXACT **33** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **1**
- Layer records with no IMSR match: **386** (expected — IMSR lists only large incidents)
...
| TX-MCR/Mud Bayou | **EXACT** | 2026-TXMCR-000389 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| CA-MRN/Chileno | **EXACT** | 2026-CAMRN-002615 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
...
| MO-MTF/Tabor | **EXACT** | 2026-MOMTF-000368 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
