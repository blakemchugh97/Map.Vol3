# IMSR ↔ incident-layer match — 2026-09-22

- IMSR source: `tests/imsr/out/imsr-2026-09-22-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-22.json` (456 records)
- **Extracted IMSR rows are UNVERIFIED; this measures record MATCHING, not parser or value correctness.**

## Match summary
- IMSR incidents compared: **32**
- Match rate (exact+strong+weak): **93.8%**
- EXACT **30** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **2**
- Layer records with no IMSR match: **426** (expected — IMSR lists only large incidents)
...
|---|---|---|---|---|
| LA-LAS/Round Prarie | **EXACT** | 2026-LALAS-000390 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
