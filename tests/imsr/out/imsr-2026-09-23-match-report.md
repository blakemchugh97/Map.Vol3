# IMSR ↔ incident-layer match — 2026-09-23

- IMSR source: `tests/imsr/out/imsr-2026-09-23-extracted.json`
- Layer source: `tests/imsr/incident_layer/wfigs-usa-wildfires-snapshot-2026-09-23.json` (478 records)
...
- EXACT **29** · STRONG **0** · WEAK **0** · AMBIGUOUS **0** · NO_MATCH **1**
- Layer records with no IMSR match: **449** (expected — IMSR lists only large incidents)
...
| TX-TXS/Seven | **EXACT** | 2026-TXTXS-268873 | 1.0 | name=EX,unit=Y,st=Y,yr=Y |
